 ...
 */
public class TestPrincetonPlayer {
	...
	public static void setPlayVerbose(boolean playVerbose) {
		TestPrincetonPlayer.playVerbose = playVerbose;
	}
	 ...
	 */
	public TestPrincetonPlayer(GinRummyPlayer player0, GinRummyPlayer player1) {
	...
	public static void main(String[] args) {
		...
		setPlayVerbose(true);
		new TestPrincetonPlayer(new SimpleGinRummyPlayer(), new PrincetonGinPlayer()).play();
		...
		int numGames = 1; // CHANGE THIS AS DESIRED
		int numP1Wins = 0;
		TestPrincetonPlayer game = new TestPrincetonPlayer(new SimpleGinRummyPlayer(), new PrincetonGinPlayer());
